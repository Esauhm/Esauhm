...
<p>
  <a href="mailto:diegoesauhm@gmail.com">
    <img src="https://img.shields.io/badge/Email-Contactarme-EA4335?style=for-the-badge&logo=gmail&logoColor=white" alt="Email" />
  </a>
...
<ul>
  ...
  <li>🎨 Desarrollo frontend con <strong>Angular</strong> y conocimientos de <strong>React</strong>.</li>
  <li>🗃️ Consultas, procedimientos almacenados y optimización en <strong>SQL Server</strong>.</li>
  <li>🔄 Integraciones, automatización y procesos de <strong>CI/CD</strong>.</li>
  <li>🐳 Uso de <strong>Docker</strong>, <strong>GitHub Actions</strong>, <strong>Jenkins</strong> y servicios de <strong>AWS</strong>.</li>
  <li>🧩 Resolución de incidencias, mantenimiento de sistemas y desarrollo de requerimientos orientados al negocio.</li>
</ul>
...
<table>
  <tr>
    <td width="58%" valign="top">
      ...
      <p>
        Backend empresarial desarrollado con <strong>.NET 10</strong> para gestionar
        áreas de especialización, consultores, paquetes de servicio, autenticación
        por roles y reportes administrativos.
      </p>
      <p>
        El proyecto demuestra prácticas de desarrollo backend de nivel
        <strong>Middle</strong>, incluyendo arquitectura, seguridad, consistencia
...
<p>
  Este proyecto integra prácticas de arquitectura, seguridad, persistencia,
  pruebas automatizadas, contenedores e integración continua utilizadas en
  soluciones backend empresariales.
</p>
...
Aplicación web desarrollada para una cafetería, orientada a la gestión de ventas y creación de eventos.
...
Aplicación móvil desarrollada como proyecto universitario, enfocada en encuestas y juegos interactivos.
...
Aplicación móvil desarrollada para un negocio local, orientada a la gestión y visualización de productos y servicios.
...
🚀 Construyendo soluciones limpias, escalables y orientadas al negocio
